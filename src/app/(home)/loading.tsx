import { Skeleton, SkeletonAnnounce, SkeletonButton, SkeletonImage, SkeletonText } from "@/components/ui/Skeleton";

/** Mirrors Hero.tsx + the stats row, so the homepage doesn't jump when data arrives. */
export default function Loading() {
  return (
    <section className="relative isolate overflow-hidden pb-8 pt-16 sm:pb-10" aria-busy="true">
      <SkeletonAnnounce />
